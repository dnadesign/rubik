			...
			var c = $(this),
				...
				Rubik = {
					...
					assessContainers: function () {
						...
						if (Modernizr.csstransforms && Modernizr.touch && pages.length > 1) {
					...
					setupHTML: function() {
						...
						slides = inner.children('.' + opts.domItemClass);
						slides.each(function() {
							var el = $(this)
					...
					setupTimers: function () {
						if (opts.autoStart == true && pages && pages.length > 1) {
							timer.play();
						}
					},
